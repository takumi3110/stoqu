...
class StorageItemAdmin(admin.ModelAdmin):
	...
	search_fields = ('order_number', 'item__pc__name', 'base__name')
	actions_on_bottom = True
...
class StorageCartAdmin(admin.ModelAdmin):
	list_display = ('requester', 'price', 'ordered')
	list_display_links = ('requester', 'price', 'ordered')
	list_filter = ('requester', 'ordered')
	search_fields = ('requester__user__screenname',)
	actions_on_bottom = True
...
class OrderInfoAdmin(admin.ModelAdmin):
	...
	search_fields = ('number', 'ticket', 'approve')
	actions_on_bottom = True
